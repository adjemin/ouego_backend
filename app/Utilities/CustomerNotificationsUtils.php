...
class CustomerNotificationsUtils
{
     ...
     */
    public static function notify(CustomerNotification $userNotification){
        $user = Customer::where(["id" => $userNotification->customer_id])->first();
