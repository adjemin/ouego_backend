...
class DriverAPIController extends AppBaseController
{
    ...
    public function __construct(DriverRepository $driverRepo, EnginRepository $enginRepo, NewJWTAuth $jwtAuth, OrangeSMSService $orangeSMSService)
    {
    ...
    public function refresh(Request $request)
    {
        try {
            ...
            $device = DriverDevice::where('firebase_id', $payload['device_id'])->orderBy('created_at', 'desc')->firstOrFail();
